...
public class SetmealController {
    ...
    public R<String> delete(@RequestParam List<Long> ids){
        ...
        lambdaQueryWrapper.in(SetmealDish::getSetmealId,ids); //in方法可批量删除
    ...
    public R<SetmealDto> update(@PathVariable Long id){
        ...
        lambdaQueryWrapper1.eq(Category::getId,setmeal.getCategoryId());
        setmealDto.setCategoryName(categoryService.getOne(lambdaQueryWrapper1).getName());
